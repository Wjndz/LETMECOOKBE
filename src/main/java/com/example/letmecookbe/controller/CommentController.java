...
@RequestMapping("/recipes/{recipeId}/comments") // Định nghĩa base URL cho comment của một recipe cụ thể
...
public class CommentController {
    ...
    public ResponseEntity<CommentResponse> getCommentById(@PathVariable String recipeId, @PathVariable int commentId) {
